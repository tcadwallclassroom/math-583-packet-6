...
1. Conduct a simulation-based hypothesis test using the null hypothesis that $p=0.5$ (that is, the null hypothesis is that the monkey is choosing randomly), and alternative hypothesis $p \ne 0.5$ (that is, a two-tailed hypothesis test). What p-value do you get?
